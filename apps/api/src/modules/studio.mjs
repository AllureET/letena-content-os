...
export const HOUSE_IMAGE_RULES = [
  ...
  'OBJECTS: everything on a shelf, desk or surface must be something that room actually uses. A consultation room holds clinical instruments in a tray, sterile packs, a blood-pressure cuff, a kidney dish, an anatomical or pelvic teaching model, folded surgical drapes, a specimen jar, a jar of cotton. A studio corner holds a microphone, a headphone hook, acoustic panels, a side table. Never fill shelves with stacked towels, rows of pottery, ornaments or anything arranged as a display.',
  'DECORATIVE CRAFT: none. No baskets, no clay pots, no weaving, no ornaments. Ethiopia reads through the people, the light, the woven rug underfoot and the palette, not through craft objects on shelves.',
